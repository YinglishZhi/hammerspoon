...
-- 网易音乐控制
-- hs.hotkey.bind(hyperAlt, 'Right', function() hs.neteaseMusic.previous() end)
-- hs.hotkey.bind(hyperAlt, 'Left', function() hs.neteaseMusic.next() end)
-- hs.hotkey.bind(hyperAlt11, 'Enter', function() hs.neteaseMusic.playpause() end)
